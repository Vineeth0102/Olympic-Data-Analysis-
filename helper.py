...
def most_successful(df, sport):
    ...
    x = top_athletes.merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport', 'region']].drop_duplicates('Name')
    return x
...
def most_successful_countrywise(df, country):
    ...
    x = top_athletes.merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport']].drop_duplicates('Name')
